...
> 微信读书官方 Skill 的 Agent 优化版——CLI + 缓存 + 合并命令，为 Agent 环境量身打造。
...
### 2. shelf --summary / --fields — 按需输出

书架有 670 本书？全量 JSON 是 239K chars，但用户可能只需要统计。
